#############################################################################
# Makefile for building: QtMatchGame.app/Contents/MacOS/QtMatchGame
# Generated by qmake (3.1) (Qt 6.4.3)
# Project:  QtMatchGame.pro
# Template: app
# Command: /opt/homebrew/bin/qmake -o Makefile QtMatchGame.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = QtMatchGame1.0.0
DISTDIR = /Users/kilic/Documents/Projects/C:C++/QtMatchGame/.tmp/QtMatchGame1.0.0
...
DIST          = /opt/homebrew/share/qt/mkspecs/features/spec_pre.prf \
		...
		/opt/homebrew/Cellar/qt/6.4.3_3/share/qt/mkspecs/common/unix.conf \
		/opt/homebrew/Cellar/qt/6.4.3_3/share/qt/mkspecs/common/mac.conf \
		/opt/homebrew/Cellar/qt/6.4.3_3/share/qt/mkspecs/common/macx.conf \
		/opt/homebrew/Cellar/qt/6.4.3_3/share/qt/mkspecs/common/sanitize.conf \
		/opt/homebrew/Cellar/qt/6.4.3_3/share/qt/mkspecs/common/gcc-base.conf \
		/opt/homebrew/Cellar/qt/6.4.3_3/share/qt/mkspecs/common/gcc-base-mac.conf \
		/opt/homebrew/Cellar/qt/6.4.3_3/share/qt/mkspecs/common/clang.conf \
		/opt/homebrew/Cellar/qt/6.4.3_3/share/qt/mkspecs/common/clang-mac.conf \
		...
		QtMatchGame.pro mainwindow.h main.cpp \
		mainwindow.cpp
QMAKE_TARGET  = QtMatchGame
DESTDIR       = 
TARGET        = QtMatchGame.app/Contents/MacOS/QtMatchGame

####### Custom Variables
EXPORT_QMAKE_MAC_SDK = macosx
EXPORT_QMAKE_MAC_SDK_VERSION = 13.3
EXPORT_QMAKE_XCODE_DEVELOPER_PATH = /Library/Developer/CommandLineTools
EXPORT__QMAKE_STASH_ = /Users/kilic/Documents/Projects/C:C++/QtMatchGame/.qmake.stash
...
EXPORT__PRO_FILE_ = /Users/kilic/Documents/Projects/C:C++/QtMatchGame/QtMatchGame.pro


include /opt/homebrew/Cellar/qt/6.4.3_3/share/qt/mkspecs/features/mac/sdk.mk
first: all
####### Build rules

QtMatchGame.app/Contents/MacOS/QtMatchGame: ui_mainwindow.h $(OBJECTS)  
	@test -d QtMatchGame.app/Contents/MacOS/ || mkdir -p QtMatchGame.app/Contents/MacOS/
	$(LINK) $(LFLAGS) -o $(TARGET)  $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: QtMatchGame.pro /opt/homebrew/share/qt/mkspecs/macx-clang/qmake.conf /opt/homebrew/share/qt/mkspecs/features/spec_pre.prf \
		/opt/homebrew/share/qt/mkspecs/features/device_config.prf \
		/opt/homebrew/Cellar/qt/6.4.3_3/share/qt/mkspecs/common/unix.conf \
		/opt/homebrew/Cellar/qt/6.4.3_3/share/qt/mkspecs/common/mac.conf \
		/opt/homebrew/Cellar/qt/6.4.3_3/share/qt/mkspecs/common/macx.conf \
	...
	$(QMAKE) -o Makefile QtMatchGame.pro
...
QtMatchGame.app/Contents/PkgInfo: 
	@test -d QtMatchGame.app/Contents || mkdir -p QtMatchGame.app/Contents
	@$(DEL_FILE) QtMatchGame.app/Contents/PkgInfo
	@echo "APPL????" > QtMatchGame.app/Contents/PkgInfo
QtMatchGame.app/Contents/Resources/empty.lproj: 
	@test -d QtMatchGame.app/Contents/Resources || mkdir -p QtMatchGame.app/Contents/Resources
	@touch QtMatchGame.app/Contents/Resources/empty.lproj
	
QtMatchGame.app/Contents/Info.plist: 
	@test -d QtMatchGame.app/Contents || mkdir -p QtMatchGame.app/Contents
	@$(DEL_FILE) QtMatchGame.app/Contents/Info.plist
	@sed -e "s,@SHORT_VERSION@,1.0,g" -e "s,\$${QMAKE_SHORT_VERSION},1.0,g" -e "s,@FULL_VERSION@,1.0.0,g" -e "s,\$${QMAKE_FULL_VERSION},1.0.0,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" -e "s,@BUNDLEIDENTIFIER@,com.yourcompany.QtMatchGame,g" -e "s,\$${PRODUCT_BUNDLE_IDENTIFIER},com.yourcompany.QtMatchGame,g" -e "s,\$${MACOSX_DEPLOYMENT_TARGET},13.0,g" -e "s,\$${IPHONEOS_DEPLOYMENT_TARGET},,g" -e "s,\$${TVOS_DEPLOYMENT_TARGET},,g" -e "s,\$${WATCHOS_DEPLOYMENT_TARGET},,g" -e "s,\$${IOS_LAUNCH_SCREEN},LaunchScreen,g" -e "s,@ICON@,,g" -e "s,\$${ASSETCATALOG_COMPILER_APPICON_NAME},,g" -e "s,@EXECUTABLE@,QtMatchGame,g" -e "s,@LIBRARY@,QtMatchGame,g" -e "s,\$${EXECUTABLE_NAME},QtMatchGame,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" /opt/homebrew/share/qt/mkspecs/macx-clang/Info.plist.app >QtMatchGame.app/Contents/Info.plist

all: Makefile \
		QtMatchGame.app/Contents/PkgInfo \
		QtMatchGame.app/Contents/Resources/empty.lproj \
		QtMatchGame.app/Contents/Info.plist QtMatchGame.app/Contents/MacOS/QtMatchGame
...
moc_mainwindow.cpp: mainwindow.h \
	...
	/opt/homebrew/share/qt/libexec/moc $(DEFINES) --include /Users/kilic/Documents/Projects/C:C++/QtMatchGame/moc_predefs.h -I/opt/homebrew/share/qt/mkspecs/macx-clang -I/Users/kilic/Documents/Projects/C:C++/QtMatchGame -I/Users/kilic/Documents/Projects/C:C++/QtMatchGame -I/opt/homebrew/lib/QtWidgets.framework/Headers -I/opt/homebrew/lib/QtGui.framework/Headers -I/opt/homebrew/lib/QtCore.framework/Headers -I/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/c++/v1 -I/Library/Developer/CommandLineTools/usr/lib/clang/14.0.3/include -I/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include -I/Library/Developer/CommandLineTools/usr/include -F/opt/homebrew/lib mainwindow.h -o moc_mainwindow.cpp
